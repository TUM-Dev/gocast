...
type IntegrationCourse struct {
	...
	TeachingTerm  string                 `protobuf:"bytes,5,opt,name=teaching_term,json=teachingTerm,proto3" json:"teaching_term,omitempty"`
...
func (x *IntegrationCourse) Reset() {
	*x = IntegrationCourse{}
...
func (x *IntegrationCourse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IntegrationCourse) ProtoMessage() {}

func (x *IntegrationCourse) ProtoReflect() protoreflect.Message {
	mi := &file_server_apiv2_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use IntegrationCourse.ProtoReflect.Descriptor instead.
func (*IntegrationCourse) Descriptor() ([]byte, []int) {
	return file_server_apiv2_proto_rawDescGZIP(), []int{0}
}

func (x *IntegrationCourse) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *IntegrationCourse) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *IntegrationCourse) GetSlug() string {
	if x != nil {
		return x.Slug
	}
	return ""
...
func (x *IntegrationCourse) GetYear() int32 {
	if x != nil {
		return x.Year
	}
	return 0
...
func (x *IntegrationCourse) GetTeachingTerm() string {
	if x != nil {
...
func (x *IntegrationCourse) GetVodEnabled() bool {
	if x != nil {
		return x.VodEnabled
	}
	return false
...
func (x *IntegrationCourse) GetVisibility() string {
	if x != nil {
		return x.Visibility
	}
	return ""
...
func (x *IntegrationStream) Reset() {
	*x = IntegrationStream{}
...
func (x *IntegrationStream) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IntegrationStream) ProtoMessage() {}

func (x *IntegrationStream) ProtoReflect() protoreflect.Message {
	mi := &file_server_apiv2_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IntegrationStream.ProtoReflect.Descriptor instead.
func (*IntegrationStream) Descriptor() ([]byte, []int) {
	return file_server_apiv2_proto_rawDescGZIP(), []int{1}
}

func (x *IntegrationStream) GetStreamId() uint32 {
	if x != nil {
		return x.StreamId
	}
	return 0
...
func (x *IntegrationStream) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *IntegrationStream) GetPrivate() bool {
	if x != nil {
		return x.Private
	}
	return false
...
func (x *IntegrationStream) GetStart() *timestamppb.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *IntegrationStream) GetEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
type ListAdministeredCoursesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListAdministeredCoursesRequest) Reset() {
	*x = ListAdministeredCoursesRequest{}
	mi := &file_server_apiv2_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListAdministeredCoursesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListAdministeredCoursesRequest) ProtoMessage() {}

func (x *ListAdministeredCoursesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_server_apiv2_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListAdministeredCoursesRequest.ProtoReflect.Descriptor instead.
func (*ListAdministeredCoursesRequest) Descriptor() ([]byte, []int) {
	return file_server_apiv2_proto_rawDescGZIP(), []int{2}
}

func (x *ListAdministeredCoursesRequest) GetLrzId() string {
	if x != nil {
		return x.LrzId
	}
	return ""
...
func (x *ListAdministeredCoursesRequest) GetYear() int32 {
	if x != nil {
		return x.Year
	}
	return 0
...
func (x *ListAdministeredCoursesRequest) GetTerm() string {
	if x != nil {
		return x.Term
	}
	return ""
...
type ListAdministeredCoursesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Courses       []*IntegrationCourse   `protobuf:"bytes,1,rep,name=courses,proto3" json:"courses,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListAdministeredCoursesResponse) GetCourses() []*IntegrationCourse {
	if x != nil {
		return x.Courses
	}
	return nil
...
type ListCourseStreamsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListCourseStreamsRequest) Reset() {
	*x = ListCourseStreamsRequest{}
	mi := &file_server_apiv2_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListCourseStreamsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListCourseStreamsRequest) ProtoMessage() {}

func (x *ListCourseStreamsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_server_apiv2_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListCourseStreamsRequest.ProtoReflect.Descriptor instead.
func (*ListCourseStreamsRequest) Descriptor() ([]byte, []int) {
	return file_server_apiv2_proto_rawDescGZIP(), []int{4}
}

func (x *ListCourseStreamsRequest) GetCourseId() uint32 {
	if x != nil {
		return x.CourseId
	}
	return 0
...
type ListCourseStreamsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Streams       []*IntegrationStream   `protobuf:"bytes,1,rep,name=streams,proto3" json:"streams,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListCourseStreamsResponse) Reset() {
	*x = ListCourseStreamsResponse{}
	mi := &file_server_apiv2_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListCourseStreamsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListCourseStreamsResponse) ProtoMessage() {}

func (x *ListCourseStreamsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_server_apiv2_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListCourseStreamsResponse.ProtoReflect.Descriptor instead.
func (*ListCourseStreamsResponse) Descriptor() ([]byte, []int) {
	return file_server_apiv2_proto_rawDescGZIP(), []int{5}
}

func (x *ListCourseStreamsResponse) GetStreams() []*IntegrationStream {
	if x != nil {
		return x.Streams
	}
	return nil
...
func (x *GetPlaybackTokenRequest) Reset() {
	*x = GetPlaybackTokenRequest{}
	mi := &file_server_apiv2_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetPlaybackTokenRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPlaybackTokenRequest) ProtoMessage() {}

func (x *GetPlaybackTokenRequest) ProtoReflect() protoreflect.Message {
	mi := &file_server_apiv2_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPlaybackTokenRequest.ProtoReflect.Descriptor instead.
func (*GetPlaybackTokenRequest) Descriptor() ([]byte, []int) {
	return file_server_apiv2_proto_rawDescGZIP(), []int{6}
}

func (x *GetPlaybackTokenRequest) GetCourseId() uint32 {
	if x != nil {
		return x.CourseId
	}
	return 0
...
func (x *GetPlaybackTokenRequest) GetStreamId() uint32 {
	if x != nil {
		return x.StreamId
	}
	return 0
...
func (x *GetPlaybackTokenRequest) GetTtlSeconds() int32 {
	if x != nil {
		return x.TtlSeconds
	}
	return 0
...
type GetPlaybackTokenResponse struct {
	...
	PlaylistUrlPres string                 `protobuf:"bytes,2,opt,name=playlist_url_pres,json=playlistUrlPres,proto3" json:"playlist_url_pres,omitempty"`
	PlaylistUrlCam  string                 `protobuf:"bytes,3,opt,name=playlist_url_cam,json=playlistUrlCam,proto3" json:"playlist_url_cam,omitempty"`
	ExpiresIn       int32                  `protobuf:"varint,4,opt,name=expires_in,json=expiresIn,proto3" json:"expires_in,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *GetPlaybackTokenResponse) Reset() {
	*x = GetPlaybackTokenResponse{}
	mi := &file_server_apiv2_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetPlaybackTokenResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPlaybackTokenResponse) ProtoMessage() {}

func (x *GetPlaybackTokenResponse) ProtoReflect() protoreflect.Message {
	mi := &file_server_apiv2_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPlaybackTokenResponse.ProtoReflect.Descriptor instead.
func (*GetPlaybackTokenResponse) Descriptor() ([]byte, []int) {
	return file_server_apiv2_proto_rawDescGZIP(), []int{7}
}

func (x *GetPlaybackTokenResponse) GetPlaylistUrl() string {
	if x != nil {
...
func (x *GetPlaybackTokenResponse) GetPlaylistUrlPres() string {
	if x != nil {
...
func (x *GetPlaybackTokenResponse) GetPlaylistUrlCam() string {
	if x != nil {
...
func (x *GetPlaybackTokenResponse) GetExpiresIn() int32 {
	if x != nil {
		return x.ExpiresIn
	}
	return 0
...
func (x *GetBindingStatusRequest) Reset() {
	*x = GetBindingStatusRequest{}
	mi := &file_server_apiv2_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBindingStatusRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBindingStatusRequest) ProtoMessage() {}

func (x *GetBindingStatusRequest) ProtoReflect() protoreflect.Message {
	mi := &file_server_apiv2_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBindingStatusRequest.ProtoReflect.Descriptor instead.
func (*GetBindingStatusRequest) Descriptor() ([]byte, []int) {
	return file_server_apiv2_proto_rawDescGZIP(), []int{8}
}

func (x *GetBindingStatusRequest) GetCourseId() uint32 {
	if x != nil {
		return x.CourseId
	}
	return 0
...
func (x *GetBindingStatusResponse) Reset() {
	*x = GetBindingStatusResponse{}
	mi := &file_server_apiv2_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBindingStatusResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBindingStatusResponse) ProtoMessage() {}

func (x *GetBindingStatusResponse) ProtoReflect() protoreflect.Message {
	mi := &file_server_apiv2_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBindingStatusResponse.ProtoReflect.Descriptor instead.
func (*GetBindingStatusResponse) Descriptor() ([]byte, []int) {
	return file_server_apiv2_proto_rawDescGZIP(), []int{9}
}

func (x *GetBindingStatusResponse) GetBound() bool {
	if x != nil {
		return x.Bound
	}
	return false
...
const file_server_apiv2_proto_rawDesc = "" +
	"\n" +
	"\x12server/apiv2.proto\x12\bprotobuf\x1a\x1cgoogle/api/annotations.proto\x1a\x19google/api/httpbody.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"\xc5\x01\n" +
	"\x11IntegrationCourse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04slug\x18\x03 \x01(\tR\x04slug\x12\x12\n" +
	"\x04year\x18\x04 \x01(\x05R\x04year\x12#\n" +
	"\rteaching_term\x18\x05 \x01(\tR\fteachingTerm\x12\x1f\n" +
	"\vvod_enabled\x18\x06 \x01(\bR\n" +
	"vodEnabled\x12\x1e\n" +
	"\n" +
	"visibility\x18\a \x01(\tR\n" +
	"visibility\"\xbe\x01\n" +
	"\x11IntegrationStream\x12\x1b\n" +
	"\tstream_id\x18\x01 \x01(\rR\bstreamId\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x18\n" +
	"\aprivate\x18\x03 \x01(\bR\aprivate\x120\n" +
	"\x05start\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x05start\x12,\n" +
	"\x03end\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x03end\"_\n" +
	"\x1eListAdministeredCoursesRequest\x12\x15\n" +
	"\x06lrz_id\x18\x01 \x01(\tR\x05lrzId\x12\x12\n" +
	"\x04year\x18\x02 \x01(\x05R\x04year\x12\x12\n" +
	"\x04term\x18\x03 \x01(\tR\x04term\"X\n" +
	"\x1fListAdministeredCoursesResponse\x125\n" +
	"\acourses\x18\x01 \x03(\v2\x1b.protobuf.IntegrationCourseR\acourses\"7\n" +
	"\x18ListCourseStreamsRequest\x12\x1b\n" +
	"\tcourse_id\x18\x01 \x01(\rR\bcourseId\"R\n" +
	"\x19ListCourseStreamsResponse\x125\n" +
	"\astreams\x18\x01 \x03(\v2\x1b.protobuf.IntegrationStreamR\astreams\"t\n" +
	"\x17GetPlaybackTokenRequest\x12\x1b\n" +
	"\tcourse_id\x18\x01 \x01(\rR\bcourseId\x12\x1b\n" +
	"\tstream_id\x18\x02 \x01(\rR\bstreamId\x12\x1f\n" +
	"\vttl_seconds\x18\x03 \x01(\x05R\n" +
	"ttlSeconds\"\xb2\x01\n" +
	"\x18GetPlaybackTokenResponse\x12!\n" +
	"\fplaylist_url\x18\x01 \x01(\tR\vplaylistUrl\x12*\n" +
	"\x11playlist_url_pres\x18\x02 \x01(\tR\x0fplaylistUrlPres\x12(\n" +
	"\x10playlist_url_cam\x18\x03 \x01(\tR\x0eplaylistUrlCam\x12\x1d\n" +
	"\n" +
	"expires_in\x18\x04 \x01(\x05R\texpiresIn\"6\n" +
	"\x17GetBindingStatusRequest\x12\x1b\n" +
	"\tcourse_id\x18\x01 \x01(\rR\bcourseId\"0\n" +
	"\x18GetBindingStatusResponse\x12\x14\n" +
	"\x05bound\x18\x01 \x01(\bR\x05bound\"-\n" +
	"\x13HealthCheckResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\"\x85\x04\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x12\n" +
	...
	"\bbookmark\x18\x01 \x01(\v2\x12.protobuf.BookmarkR\bbookmark\"\x96\x05\n" +
	"\x06Course\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	...
	"\x11last_recording_id\x18\x0f \x01(\rR\x0flastRecordingId\x12&\n" +
	"\x0fnext_lecture_id\x18\x10 \x01(\rR\rnextLectureId\"A\n" +
	...
	"\tsemesters\x18\x02 \x03(\v2\x12.protobuf.SemesterR\tsemesters\"\xe0\a\n" +
	"\x06Stream\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x12\n" +
	...
	"isComingUp\x12\x17\n" +
	"\ahls_url\x18  \x01(\tR\x06hlsUrl\"\xd9\x02\n" +
	...
	"\x14server_notifications\x18\x01 \x03(\v2\x1c.protobuf.ServerNotificationR\x13serverNotifications\"p\n" +
	"\vLectureHall\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12=\n" +
	"\x0ecamera_presets\x18\x03 \x03(\v2\x16.protobuf.CameraPresetR\rcameraPresets\"T\n" +
	...
	"\x16CUSTOM_PLAYBACK_SPEEDS\x10\x02*(\n" +
	"\tVideoType\x12\b\n" +
	...
	"\fTARGET_ADMIN\x10\x042\xd8(\n" +
	"\x03API\x12\xce\x01\n" +
	"\vhealthCheck\x12\x16.google.protobuf.Empty\x1a\x1d.protobuf.HealthCheckResponse\"\x87\x01\x92Au\n" +
	"\n" +
	"API Status\x12\x11API healthcheck .\x1aTIf this endpoint does not return 200, the API is experiencing a catastrophic outage.\x82\xd3\xe4\x93\x02\t\x12\a/status\x12\x80\x01\n" +
	"\agetUser\x12\x16.google.protobuf.Empty\x1a\x19.protobuf.GetUserResponse\"B\x92A.\n" +
	"\x04User\x12\tGet user.\x1a\x1bRetrieves the current user.\x82\xd3\xe4\x93\x02\v\x12\t/users/me\x12\xac\x01\n" +
	"\rresetPassword\x12\x1e.protobuf.ResetPasswordRequest\x1a\x1f.protobuf.ResetPasswordResponse\"Z\x92A7\n" +
	"\x04User\x12\x14Reset user password.\x1a\x19Resets the user password.\x82\xd3\xe4\x93\x02\x1a:\x01*\"\x15/users/reset-password\x12\xd2\x01\n" +
	...
	"\x04User\x12\x11Export user data.\x1a Exports the current user's data.\x82\xd3\xe4\x93\x02\x0f\x12\r/users/export\x12\xbf\x01\n" +
	...
	"\aCourses\x12\x16Pin or unpin a course.\x1a%Pins or unpins a course for the user.\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/courses/{course_id}/pin\x12\xdb\x01\n" +
	...
	"\tBookmarks\x12\x12Delete a bookmark.\x1a\x13Deletes a bookmark.\x82\xd3\xe4\x93\x02\x1a*\x18/bookmarks/{bookmark_id}\x12\xbb\x01\n" +
	...
	"\vIntegration\x12)Get a signed playback token for a stream.\x1aLIssues signed, time-bounded playlist URLs for an eligible on-behalf-of user.\x82\xd3\xe4\x93\x02H:\x01*\"C/integration/courses/{course_id}/streams/{stream_id}/playback-token\x12\x95\x02\n" +
	"\x10getBindingStatus\x12!.protobuf.GetBindingStatusRequest\x1a\".protobuf.GetBindingStatusResponse\"\xb9\x01\x92A\x7f\n" +
	"\vIntegration\x12$Get the binding status for a course.\x1aJReports whether the service account is bound to the course (course admin).\x82\xd3\xe4\x93\x021\x12//integration/courses/{course_id}/binding-statusB\x8c\x04\x92A\xf6\x03\x12\xb8\x03\n" +
	"\n" +
...
var file_server_apiv2_proto_msgTypes = make([]protoimpl.MessageInfo, 68)
var file_server_apiv2_proto_goTypes = []any{
	...
	(*IntegrationCourse)(nil),               // 3: protobuf.IntegrationCourse
	(*IntegrationStream)(nil),               // 4: protobuf.IntegrationStream
	(*ListAdministeredCoursesRequest)(nil),  // 5: protobuf.ListAdministeredCoursesRequest
	(*ListAdministeredCoursesResponse)(nil), // 6: protobuf.ListAdministeredCoursesResponse
	(*ListCourseStreamsRequest)(nil),        // 7: protobuf.ListCourseStreamsRequest
	(*ListCourseStreamsResponse)(nil),       // 8: protobuf.ListCourseStreamsResponse
	(*GetPlaybackTokenRequest)(nil),         // 9: protobuf.GetPlaybackTokenRequest
	(*GetPlaybackTokenResponse)(nil),        // 10: protobuf.GetPlaybackTokenResponse
	(*GetBindingStatusRequest)(nil),         // 11: protobuf.GetBindingStatusRequest
	(*GetBindingStatusResponse)(nil),        // 12: protobuf.GetBindingStatusResponse
	(*HealthCheckResponse)(nil),             // 13: protobuf.HealthCheckResponse
	(*User)(nil),                            // 14: protobuf.User
	(*UserSetting)(nil),                     // 15: protobuf.UserSetting
	(*UpdateUserSettingsRequest)(nil),       // 16: protobuf.UpdateUserSettingsRequest
	(*ResetPasswordRequest)(nil),            // 17: protobuf.ResetPasswordRequest
	(*GetUserResponse)(nil),                 // 18: protobuf.GetUserResponse
	(*UpdateUserSettingsResponse)(nil),      // 19: protobuf.UpdateUserSettingsResponse
	(*ResetPasswordResponse)(nil),           // 20: protobuf.ResetPasswordResponse
	(*ExportPersonalDataResponse)(nil),      // 21: protobuf.ExportPersonalDataResponse
	(*Enrollment)(nil),                      // 22: protobuf.Enrollment
	(*VideoView)(nil),                       // 23: protobuf.VideoView
	(*Chat)(nil),                            // 24: protobuf.Chat
	(*Bookmark)(nil),                        // 25: protobuf.Bookmark
	(*GetBookmarksRequest)(nil),             // 26: protobuf.GetBookmarksRequest
	(*AddBookmarkRequest)(nil),              // 27: protobuf.AddBookmarkRequest
	(*UpdateBookmarkRequest)(nil),           // 28: protobuf.UpdateBookmarkRequest
	(*DeleteBookmarkRequest)(nil),           // 29: protobuf.DeleteBookmarkRequest
	(*GetBookmarksResponse)(nil),            // 30: protobuf.GetBookmarksResponse
	(*AddBookmarkResponse)(nil),             // 31: protobuf.AddBookmarkResponse
	(*UpdateBookmarkResponse)(nil),          // 32: protobuf.UpdateBookmarkResponse
	(*Course)(nil),                          // 33: protobuf.Course
	(*GetPublicCoursesRequest)(nil),         // 34: protobuf.GetPublicCoursesRequest
	(*GetCourseBySlugRequest)(nil),          // 35: protobuf.GetCourseBySlugRequest
	(*GetUserCoursesRequest)(nil),           // 36: protobuf.GetUserCoursesRequest
	(*GetPinForCourseRequest)(nil),          // 37: protobuf.GetPinForCourseRequest
	(*PinCourseRequest)(nil),                // 38: protobuf.PinCourseRequest
	(*GetLiveCoursesResponse)(nil),          // 39: protobuf.GetLiveCoursesResponse
	(*GetPublicCoursesResponse)(nil),        // 40: protobuf.GetPublicCoursesResponse
	(*GetCourseBySlugResponse)(nil),         // 41: protobuf.GetCourseBySlugResponse
	(*GetUserCoursesResponse)(nil),          // 42: protobuf.GetUserCoursesResponse
	(*GetPinnedCoursesResponse)(nil),        // 43: protobuf.GetPinnedCoursesResponse
	(*PinCourseResponse)(nil),               // 44: protobuf.PinCourseResponse
	(*GetPinForCourseResponse)(nil),         // 45: protobuf.GetPinForCourseResponse
	(*CourseStream)(nil),                    // 46: protobuf.CourseStream
	(*Semester)(nil),                        // 47: protobuf.Semester
	(*GetSemestersResponse)(nil),            // 48: protobuf.GetSemestersResponse
	(*Stream)(nil),                          // 49: protobuf.Stream
	(*StreamPlaylistEntry)(nil),             // 50: protobuf.StreamPlaylistEntry
	(*StreamProgress)(nil),                  // 51: protobuf.StreamProgress
	(*VideoSection)(nil),                    // 52: protobuf.VideoSection
	(*GetStreamRequest)(nil),                // 53: protobuf.GetStreamRequest
	(*GetVideoSectionsRequest)(nil),         // 54: protobuf.GetVideoSectionsRequest
	(*GetSubtitlesRequest)(nil),             // 55: protobuf.GetSubtitlesRequest
	(*GetStreamPlaylistRequest)(nil),        // 56: protobuf.GetStreamPlaylistRequest
	(*GetThumbsRequest)(nil),                // 57: protobuf.GetThumbsRequest
	(*GetVideoSectionsResponse)(nil),        // 58: protobuf.GetVideoSectionsResponse
	(*GetSubtitlesResponse)(nil),            // 59: protobuf.GetSubtitlesResponse
	(*GetStreamPlaylistResponse)(nil),       // 60: protobuf.GetStreamPlaylistResponse
	(*GetProgressBatchRequest)(nil),         // 61: protobuf.GetProgressBatchRequest
	(*UpdateProgressRequest)(nil),           // 62: protobuf.UpdateProgressRequest
	(*GetProgressBatchResponse)(nil),        // 63: protobuf.GetProgressBatchResponse
	(*Download)(nil),                        // 64: protobuf.Download
	(*UserGroupNotification)(nil),           // 65: protobuf.UserGroupNotification
	(*ServerNotification)(nil),              // 66: protobuf.ServerNotification
	(*GetNotificationsResponse)(nil),        // 67: protobuf.GetNotificationsResponse
	(*GetServerNotificationsResponse)(nil),  // 68: protobuf.GetServerNotificationsResponse
	(*LectureHall)(nil),                     // 69: protobuf.LectureHall
	(*CameraPreset)(nil),                    // 70: protobuf.CameraPreset
...
var file_server_apiv2_proto_depIdxs = []int32{
	71, // 0: protobuf.IntegrationStream.start:type_name -> google.protobuf.Timestamp
	71, // 1: protobuf.IntegrationStream.end:type_name -> google.protobuf.Timestamp
	3,  // 2: protobuf.ListAdministeredCoursesResponse.courses:type_name -> protobuf.IntegrationCourse
	4,  // 3: protobuf.ListCourseStreamsResponse.streams:type_name -> protobuf.IntegrationStream
	33, // 4: protobuf.User.courses:type_name -> protobuf.Course
	33, // 5: protobuf.User.administered_courses:type_name -> protobuf.Course
	33, // 6: protobuf.User.pinned_courses:type_name -> protobuf.Course
	15, // 7: protobuf.User.settings:type_name -> protobuf.UserSetting
	25, // 8: protobuf.User.bookmarks:type_name -> protobuf.Bookmark
	71, // 9: protobuf.User.created_at:type_name -> google.protobuf.Timestamp
	0,  // 10: protobuf.UserSetting.type:type_name -> protobuf.UserSettingType
	15, // 11: protobuf.UpdateUserSettingsRequest.user_settings:type_name -> protobuf.UserSetting
	14, // 12: protobuf.GetUserResponse.user:type_name -> protobuf.User
	15, // 13: protobuf.UpdateUserSettingsResponse.user_settings:type_name -> protobuf.UserSetting
	14, // 14: protobuf.ExportPersonalDataResponse.user_data:type_name -> protobuf.User
	22, // 15: protobuf.ExportPersonalDataResponse.enrollments:type_name -> protobuf.Enrollment
	23, // 16: protobuf.ExportPersonalDataResponse.video_views:type_name -> protobuf.VideoView
	24, // 17: protobuf.ExportPersonalDataResponse.chats:type_name -> protobuf.Chat
	71, // 18: protobuf.Chat.created_at:type_name -> google.protobuf.Timestamp
	25, // 19: protobuf.GetBookmarksResponse.bookmarks:type_name -> protobuf.Bookmark
	25, // 20: protobuf.AddBookmarkResponse.bookmark:type_name -> protobuf.Bookmark
	25, // 21: protobuf.UpdateBookmarkResponse.bookmark:type_name -> protobuf.Bookmark
	47, // 22: protobuf.Course.semester:type_name -> protobuf.Semester
	49, // 23: protobuf.Course.streams:type_name -> protobuf.Stream
	46, // 24: protobuf.GetLiveCoursesResponse.live_courses:type_name -> protobuf.CourseStream
	33, // 25: protobuf.GetPublicCoursesResponse.courses:type_name -> protobuf.Course
	33, // 26: protobuf.GetCourseBySlugResponse.course:type_name -> protobuf.Course
	33, // 27: protobuf.GetUserCoursesResponse.courses:type_name -> protobuf.Course
	33, // 28: protobuf.GetPinnedCoursesResponse.courses:type_name -> protobuf.Course
	33, // 29: protobuf.CourseStream.course:type_name -> protobuf.Course
	49, // 30: protobuf.CourseStream.stream:type_name -> protobuf.Stream
	69, // 31: protobuf.CourseStream.lecture_hall:type_name -> protobuf.LectureHall
	47, // 32: protobuf.GetSemestersResponse.current:type_name -> protobuf.Semester
	47, // 33: protobuf.GetSemestersResponse.semesters:type_name -> protobuf.Semester
	71, // 34: protobuf.Stream.start:type_name -> google.protobuf.Timestamp
	71, // 35: protobuf.Stream.end:type_name -> google.protobuf.Timestamp
	71, // 36: protobuf.Stream.live_now_timestamp:type_name -> google.protobuf.Timestamp
	64, // 37: protobuf.Stream.downloads:type_name -> protobuf.Download
	71, // 38: protobuf.StreamPlaylistEntry.start:type_name -> google.protobuf.Timestamp
	51, // 39: protobuf.StreamPlaylistEntry.stream_progress:type_name -> protobuf.StreamProgress
	71, // 40: protobuf.StreamPlaylistEntry.created_at:type_name -> google.protobuf.Timestamp
	1,  // 41: protobuf.GetThumbsRequest.thumb_type:type_name -> protobuf.VideoType
	52, // 42: protobuf.GetVideoSectionsResponse.sections:type_name -> protobuf.VideoSection
	50, // 43: protobuf.GetStreamPlaylistResponse.entries:type_name -> protobuf.StreamPlaylistEntry
	51, // 44: protobuf.GetProgressBatchResponse.progress_batch:type_name -> protobuf.StreamProgress
	2,  // 45: protobuf.UserGroupNotification.target:type_name -> protobuf.NotificationTarget
	71, // 46: protobuf.UserGroupNotification.created_at:type_name -> google.protobuf.Timestamp
	71, // 47: protobuf.ServerNotification.start:type_name -> google.protobuf.Timestamp
	71, // 48: protobuf.ServerNotification.expires:type_name -> google.protobuf.Timestamp
	65, // 49: protobuf.GetNotificationsResponse.notifications:type_name -> protobuf.UserGroupNotification
	66, // 50: protobuf.GetServerNotificationsResponse.server_notifications:type_name -> protobuf.ServerNotification
	70, // 51: protobuf.LectureHall.camera_presets:type_name -> protobuf.CameraPreset
	72, // 52: protobuf.API.healthCheck:input_type -> google.protobuf.Empty
	72, // 53: protobuf.API.getUser:input_type -> google.protobuf.Empty
	17, // 54: protobuf.API.resetPassword:input_type -> protobuf.ResetPasswordRequest
	16, // 55: protobuf.API.updateUserSettings:input_type -> protobuf.UpdateUserSettingsRequest
	72, // 56: protobuf.API.exportPersonalData:input_type -> google.protobuf.Empty
	72, // 57: protobuf.API.getSemesters:input_type -> google.protobuf.Empty
	34, // 58: protobuf.API.getPublicCourses:input_type -> protobuf.GetPublicCoursesRequest
	35, // 59: protobuf.API.getCourseBySlug:input_type -> protobuf.GetCourseBySlugRequest
	36, // 60: protobuf.API.getUserCourses:input_type -> protobuf.GetUserCoursesRequest
	72, // 61: protobuf.API.getPinnedCourses:input_type -> google.protobuf.Empty
	72, // 62: protobuf.API.getLiveCourses:input_type -> google.protobuf.Empty
	37, // 63: protobuf.API.getPinForCourse:input_type -> protobuf.GetPinForCourseRequest
	38, // 64: protobuf.API.pinCourse:input_type -> protobuf.PinCourseRequest
	53, // 65: protobuf.API.getStream:input_type -> protobuf.GetStreamRequest
	54, // 66: protobuf.API.getVideoSections:input_type -> protobuf.GetVideoSectionsRequest
	56, // 67: protobuf.API.getStreamPlaylist:input_type -> protobuf.GetStreamPlaylistRequest
	55, // 68: protobuf.API.getSubtitles:input_type -> protobuf.GetSubtitlesRequest
	57, // 69: protobuf.API.getThumbs:input_type -> protobuf.GetThumbsRequest
	61, // 70: protobuf.API.getProgressBatch:input_type -> protobuf.GetProgressBatchRequest
	62, // 71: protobuf.API.updateProgress:input_type -> protobuf.UpdateProgressRequest
	27, // 72: protobuf.API.addBookmark:input_type -> protobuf.AddBookmarkRequest
	26, // 73: protobuf.API.getBookmarks:input_type -> protobuf.GetBookmarksRequest
	28, // 74: protobuf.API.updateBookmark:input_type -> protobuf.UpdateBookmarkRequest
	29, // 75: protobuf.API.deleteBookmark:input_type -> protobuf.DeleteBookmarkRequest
	72, // 76: protobuf.API.getNotifications:input_type -> google.protobuf.Empty
	72, // 77: protobuf.API.getServerNotifications:input_type -> google.protobuf.Empty
	5,  // 78: protobuf.IntegrationService.listAdministeredCourses:input_type -> protobuf.ListAdministeredCoursesRequest
	7,  // 79: protobuf.IntegrationService.listCourseStreams:input_type -> protobuf.ListCourseStreamsRequest
	9,  // 80: protobuf.IntegrationService.getPlaybackToken:input_type -> protobuf.GetPlaybackTokenRequest
	11, // 81: protobuf.IntegrationService.getBindingStatus:input_type -> protobuf.GetBindingStatusRequest
	13, // 82: protobuf.API.healthCheck:output_type -> protobuf.HealthCheckResponse
	18, // 83: protobuf.API.getUser:output_type -> protobuf.GetUserResponse
	20, // 84: protobuf.API.resetPassword:output_type -> protobuf.ResetPasswordResponse
	19, // 85: protobuf.API.updateUserSettings:output_type -> protobuf.UpdateUserSettingsResponse
	21, // 86: protobuf.API.exportPersonalData:output_type -> protobuf.ExportPersonalDataResponse
	48, // 87: protobuf.API.getSemesters:output_type -> protobuf.GetSemestersResponse
	40, // 88: protobuf.API.getPublicCourses:output_type -> protobuf.GetPublicCoursesResponse
	41, // 89: protobuf.API.getCourseBySlug:output_type -> protobuf.GetCourseBySlugResponse
	42, // 90: protobuf.API.getUserCourses:output_type -> protobuf.GetUserCoursesResponse
	43, // 91: protobuf.API.getPinnedCourses:output_type -> protobuf.GetPinnedCoursesResponse
	39, // 92: protobuf.API.getLiveCourses:output_type -> protobuf.GetLiveCoursesResponse
	45, // 93: protobuf.API.getPinForCourse:output_type -> protobuf.GetPinForCourseResponse
	44, // 94: protobuf.API.pinCourse:output_type -> protobuf.PinCourseResponse
	46, // 95: protobuf.API.getStream:output_type -> protobuf.CourseStream
	58, // 96: protobuf.API.getVideoSections:output_type -> protobuf.GetVideoSectionsResponse
	60, // 97: protobuf.API.getStreamPlaylist:output_type -> protobuf.GetStreamPlaylistResponse
	73, // 98: protobuf.API.getSubtitles:output_type -> google.api.HttpBody
	73, // 99: protobuf.API.getThumbs:output_type -> google.api.HttpBody
	63, // 100: protobuf.API.getProgressBatch:output_type -> protobuf.GetProgressBatchResponse
	51, // 101: protobuf.API.updateProgress:output_type -> protobuf.StreamProgress
	31, // 102: protobuf.API.addBookmark:output_type -> protobuf.AddBookmarkResponse
	30, // 103: protobuf.API.getBookmarks:output_type -> protobuf.GetBookmarksResponse
	32, // 104: protobuf.API.updateBookmark:output_type -> protobuf.UpdateBookmarkResponse
	72, // 105: protobuf.API.deleteBookmark:output_type -> google.protobuf.Empty
	67, // 106: protobuf.API.getNotifications:output_type -> protobuf.GetNotificationsResponse
	68, // 107: protobuf.API.getServerNotifications:output_type -> protobuf.GetServerNotificationsResponse
	6,  // 108: protobuf.IntegrationService.listAdministeredCourses:output_type -> protobuf.ListAdministeredCoursesResponse
	8,  // 109: protobuf.IntegrationService.listCourseStreams:output_type -> protobuf.ListCourseStreamsResponse
	10, // 110: protobuf.IntegrationService.getPlaybackToken:output_type -> protobuf.GetPlaybackTokenResponse
	12, // 111: protobuf.IntegrationService.getBindingStatus:output_type -> protobuf.GetBindingStatusResponse
...
func file_server_apiv2_proto_init() {
	...
	file_server_apiv2_proto_msgTypes[54].OneofWrappers = []any{}
	type x struct{}
