...
const (
	...
	API_GetLoginOptions_FullMethodName        = "/protobuf.API/getLoginOptions"
...
func (c *aPIClient) GetLoginOptions(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetLoginOptionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLoginOptionsResponse)
	err := c.cc.Invoke(ctx, API_GetLoginOptions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAPIServer) GetLoginOptions(context.Context, *emptypb.Empty) (*GetLoginOptionsResponse, error) {
...
func _API_GetLoginOptions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIServer).GetLoginOptions(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_GetLoginOptions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIServer).GetLoginOptions(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var API_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _API_GetLoginOptions_Handler,
		},
		{
