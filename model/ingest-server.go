...
type IngestServer struct {
	...
	OrganizationID uint         `gorm:"not null" json:"organization_id,omitempty"` // the organization this server belongs to
	Shared         bool         // Whether the server can be shared with other organizations
}
