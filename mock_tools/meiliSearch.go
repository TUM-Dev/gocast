...
//
//	mockgen -source=meiliSearch.go -destination ../mock_tools/meiliSearch.go
//
...
func (mr *MockMeiliSearchInterfaceMockRecorder) Search(q, limit, searchType, courseFilter, streamFilter, subtitleFilter any) *gomock.Call {
...
func (mr *MockMeiliSearchInterfaceMockRecorder) SearchSubtitles(q, streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
