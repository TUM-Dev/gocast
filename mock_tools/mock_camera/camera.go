...
//
//	mockgen -source=camera.go -destination ../../mock_tools/mock_camera/camera.go
//
...
func (mr *MockCamMockRecorder) SetPreset(presetId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCamMockRecorder) TakeSnapshot(outDir any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
