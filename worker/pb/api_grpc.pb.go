...
// ToWorkerServer is the tumlive API for ToWorker service.
...
type FromWorkerClient interface {
	// JoinWorkers is a request to the tumlive to join the worker pool.
...
// FromWorkerServer is the tumlive API for FromWorker service.
