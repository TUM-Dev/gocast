...
type FromWorkerClient interface {
	...
	HlsReady(ctx context.Context, in *HlsReadyRequest, opts ...grpc.CallOption) (*HlsReadyResponse, error)
}
...
func (c *fromWorkerClient) HlsReady(ctx context.Context, in *HlsReadyRequest, opts ...grpc.CallOption) (*HlsReadyResponse, error) {
	out := new(HlsReadyResponse)
	err := c.cc.Invoke(ctx, "/api.FromWorker/HlsReady", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FromWorkerServer interface {
	...
	HlsReady(context.Context, *HlsReadyRequest) (*HlsReadyResponse, error)
...
func (UnimplementedFromWorkerServer) HlsReady(context.Context, *HlsReadyRequest) (*HlsReadyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HlsReady not implemented")
}
...
func _FromWorker_HlsReady_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HlsReadyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FromWorkerServer).HlsReady(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.FromWorker/HlsReady",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FromWorkerServer).HlsReady(ctx, req.(*HlsReadyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FromWorker_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HlsReady",
			Handler:    _FromWorker_HlsReady_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		{
