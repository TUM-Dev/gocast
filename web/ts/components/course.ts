...
export function courseContext(slug: string, year: number, term: string, userId: number): AlpineComponent {
    return {
        ...
        streamSortMode: (getFromStorage("streamSortMode") !== null && getFromStorage("streamSortMode") !== undefined) 
            ? +getFromStorage("streamSortMode") 
            : StreamSortMode.NewestFirst,
        streamFilterMode: (getFromStorage("streamFilterMode") !== null && getFromStorage("streamFilterMode") !== undefined) 
            ? +getFromStorage("streamFilterMode") 
            : StreamFilterMode.ShowWatched,
        viewMode: (getFromStorage("viewMode") !== null && getFromStorage("viewMode") !== undefined) 
            ? +getFromStorage("viewMode") 
            : ViewMode.Grid,
        groupMode: (getFromStorage("groupMode") !== null && getFromStorage("groupMode") !== undefined) 
