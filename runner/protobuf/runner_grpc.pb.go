...
const (
	...
	RunnerService_HandleVOD_FullMethodName        = "/protobuf.RunnerService/HandleVOD"
)
...
type RunnerServiceClient interface {
	...
	HandleVOD(ctx context.Context, in *HandleVODRequest, opts ...grpc.CallOption) (*HandleVODResponse, error)
}
...
func (c *runnerServiceClient) RequestStreamEnd(ctx context.Context, in *StreamEndRequest, opts ...grpc.CallOption) (*StreamEndResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StreamEndResponse)
	err := c.cc.Invoke(ctx, RunnerService_RequestStreamEnd_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *runnerServiceClient) HandleVOD(ctx context.Context, in *HandleVODRequest, opts ...grpc.CallOption) (*HandleVODResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HandleVODResponse)
	err := c.cc.Invoke(ctx, RunnerService_HandleVOD_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RunnerServiceServer interface {
	...
	HandleVOD(context.Context, *HandleVODRequest) (*HandleVODResponse, error)
...
func (UnimplementedRunnerServiceServer) HandleVOD(context.Context, *HandleVODRequest) (*HandleVODResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HandleVOD not implemented")
}
...
func _RunnerService_RequestStreamEnd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StreamEndRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RunnerServiceServer).RequestStreamEnd(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RunnerService_RequestStreamEnd_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RunnerServiceServer).RequestStreamEnd(ctx, req.(*StreamEndRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _RunnerService_HandleVOD_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HandleVODRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RunnerServiceServer).HandleVOD(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RunnerService_HandleVOD_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RunnerServiceServer).HandleVOD(ctx, req.(*HandleVODRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RunnerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HandleVOD",
			Handler:    _RunnerService_HandleVOD_Handler,
		},
	},
