...
const (
	...
	RunnerManagerService_RequestSelfStream_FullMethodName = "/protobuf.RunnerManagerService/RequestSelfStream"
)
...
type RunnerManagerServiceClient interface {
	...
	// Request a selfstream from the runner
...
func (c *runnerManagerServiceClient) RequestSelfStream(ctx context.Context, in *SelfStreamRequest, opts ...grpc.CallOption) (*SelfStreamResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SelfStreamResponse)
	err := c.cc.Invoke(ctx, RunnerManagerService_RequestSelfStream_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRunnerManagerServiceServer) RequestSelfStream(context.Context, *SelfStreamRequest) (*SelfStreamResponse, error) {
...
func _RunnerManagerService_RequestSelfStream_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SelfStreamRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RunnerManagerServiceServer).RequestSelfStream(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RunnerManagerService_RequestSelfStream_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RunnerManagerServiceServer).RequestSelfStream(ctx, req.(*SelfStreamRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RunnerManagerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RunnerManagerService_RequestSelfStream_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "runner.proto",
