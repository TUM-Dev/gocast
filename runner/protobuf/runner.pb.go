...
func (x *HandleVODRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HandleVODRequest) ProtoMessage() {}

func (x *HandleVODRequest) ProtoReflect() protoreflect.Message {
	mi := &file_runner_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HandleVODRequest.ProtoReflect.Descriptor instead.
func (*HandleVODRequest) Descriptor() ([]byte, []int) {
	return file_runner_proto_rawDescGZIP(), []int{6}
}

func (x *HandleVODRequest) GetStreamId() uint64 {
	if x != nil && x.StreamId != nil {
		return *x.StreamId
	}
	return 0
...
func (x *HandleVODRequest) GetVersion() StreamVersion {
	if x != nil && x.Version != nil {
		return *x.Version
	}
	return StreamVersion_STREAM_VERSION_UNSPECIFIED
...
func (x *HandleVODRequest) GetFilepath() string {
...
func (x *HandleVODResponse) Reset() {
	*x = HandleVODResponse{}
...
func (x *HandleVODResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HandleVODResponse) ProtoMessage() {}

func (x *HandleVODResponse) ProtoReflect() protoreflect.Message {
	mi := &file_runner_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HandleVODResponse.ProtoReflect.Descriptor instead.
func (*HandleVODResponse) Descriptor() ([]byte, []int) {
	return file_runner_proto_rawDescGZIP(), []int{7}
}

func (x *HandleVODResponse) GetJobId() string {
	if x != nil && x.JobId != nil {
		return *x.JobId
	}
	return ""
...
var file_runner_proto_goTypes = []any{
	...
	(*HandleVODRequest)(nil),      // 6: protobuf.HandleVODRequest
	(*HandleVODResponse)(nil),     // 7: protobuf.HandleVODResponse
...
var file_runner_proto_depIdxs = []int32{
	...
	8,  // 2: protobuf.HandleVODRequest.version:type_name -> protobuf.StreamVersion
	...
	6,  // 5: protobuf.RunnerService.HandleVOD:input_type -> protobuf.HandleVODRequest
	4,  // 6: protobuf.RunnerManagerService.Register:input_type -> protobuf.RegisterRequest
	10, // 7: protobuf.RunnerManagerService.Notify:input_type -> protobuf.Notification
	...
	7,  // 10: protobuf.RunnerService.HandleVOD:output_type -> protobuf.HandleVODResponse
	5,  // 11: protobuf.RunnerManagerService.Register:output_type -> protobuf.RegisterResponse
	11, // 12: protobuf.RunnerManagerService.Notify:output_type -> protobuf.NotificationResponse
