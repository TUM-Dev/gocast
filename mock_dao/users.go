...
//
//	mockgen -source=dao/users.go -destination mock_dao/users.go
//
...
func (mr *MockUsersDaoMockRecorder) AddUsersToCourseByTUMIDs(matrNr, courseID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) AreUsersEmpty(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) CreateRegisterLink(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) CreateUser(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) DeleteResetKey(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) DeleteUser(ctx, uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) GetAllAdminsAndLecturers(users any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) GetUserByEmail(ctx, email any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) GetUserByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByID", reflect.TypeOf((*MockUsersDao)(nil).GetUserByID), ctx, id)
}

// GetUserByLrzID mocks base method.
func (m *MockUsersDao) GetUserByLrzID(lrzID string) (model.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUserByLrzID", lrzID)
	ret0, _ := ret[0].(model.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUserByLrzID indicates an expected call of GetUserByLrzID.
func (mr *MockUsersDaoMockRecorder) GetUserByLrzID(lrzID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByLrzID", reflect.TypeOf((*MockUsersDao)(nil).GetUserByLrzID), lrzID)
}
...
func (mr *MockUsersDaoMockRecorder) GetUserByResetKey(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) HasPinnedCourse(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) IsUserAdmin(ctx, uid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) PinCourse(user, course, pin any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) SearchUser(query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) SearchUserWithRole(query, role any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) UpdateUser(user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUsersDaoMockRecorder) UpsertUser(user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
