...
//
//	mockgen -source=lecture_halls.go -destination ../mock_dao/lecture_halls.go
//
...
func (mr *MockLectureHallsDaoMockRecorder) CreateLectureHall(lectureHall any) *gomock.Call {
...
func (mr *MockLectureHallsDaoMockRecorder) DeleteLectureHall(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLectureHallsDaoMockRecorder) FindPreset(lectureHallID, presetID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLectureHallsDaoMockRecorder) GetLectureHallByID(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLectureHallsDaoMockRecorder) GetLectureHallByPartialName(name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLectureHallsDaoMockRecorder) GetStreamsForLectureHallIcal(userId, lectureHalls, all any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLectureHallsDaoMockRecorder) SaveLectureHall(lectureHall any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLectureHallsDaoMockRecorder) SaveLectureHallFullAssoc(lectureHall any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLectureHallsDaoMockRecorder) SavePreset(preset any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockLectureHallsDaoMockRecorder) UnsetDefaults(lectureHallID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
