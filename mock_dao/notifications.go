...
//
//	mockgen -source=notifications.go -destination ../mock_dao/notifications.go
//
...
func (mr *MockNotificationsDaoMockRecorder) AddNotification(notification any) *gomock.Call {
...
func (mr *MockNotificationsDaoMockRecorder) DeleteNotification(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockNotificationsDaoMockRecorder) GetNotifications(target ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
