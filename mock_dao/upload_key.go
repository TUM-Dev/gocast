...
//
//	mockgen -source=upload_key.go -destination ../mock_dao/upload_key.go
//
...
func (mr *MockUploadKeyDaoMockRecorder) CreateUploadKey(key, stream, videoType any) *gomock.Call {
...
func (mr *MockUploadKeyDaoMockRecorder) DeleteUploadKey(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockUploadKeyDaoMockRecorder) GetUploadKey(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
