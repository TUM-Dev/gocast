...
//
//	mockgen -source=server-notification.go -destination ../mock_dao/server-notification.go
//
...
func (mr *MockServerNotificationDaoMockRecorder) CreateServerNotification(notification any) *gomock.Call {
...
func (mr *MockServerNotificationDaoMockRecorder) DeleteServerNotification(notificationId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServerNotificationDaoMockRecorder) UpdateServerNotification(notification, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
