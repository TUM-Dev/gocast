...
//
//	mockgen -source=worker.go -destination ../mock_dao/worker.go
//
...
func (mr *MockWorkerDaoMockRecorder) CreateWorker(worker any) *gomock.Call {
...
func (mr *MockWorkerDaoMockRecorder) DeleteWorker(workerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerDaoMockRecorder) GetWorkerByHostname(ctx, hostname any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerDaoMockRecorder) GetWorkerByID(ctx, workerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWorkerDaoMockRecorder) SaveWorker(worker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
