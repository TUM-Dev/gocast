...
//
//	mockgen -source=file.go -destination ../mock_dao/file.go
//
...
func (mr *MockFileDaoMockRecorder) DeleteFile(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileDaoMockRecorder) GetFileById(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileDaoMockRecorder) NewFile(f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileDaoMockRecorder) SetThumbnail(streamId, thumb any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFileDaoMockRecorder) UpdateFile(id, f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
