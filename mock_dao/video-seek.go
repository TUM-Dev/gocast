...
//
//	mockgen -source=video-seek.go -destination ../mock_dao/video-seek.go
//
...
func (mr *MockVideoSeekDaoMockRecorder) Add(streamID, pos any) *gomock.Call {
...
func (mr *MockVideoSeekDaoMockRecorder) Get(streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
