...
//
//	mockgen -source=camera-preset.go -destination ../mock_dao/camera-preset.go
//
...
func (mr *MockCameraPresetDaoMockRecorder) GetDefaultCameraPreset(lectureHallID any) *gomock.Call {
