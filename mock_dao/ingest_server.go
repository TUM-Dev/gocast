...
//
//	mockgen -source=ingest_server.go -destination ../mock_dao/ingest_server.go
//
...
func (mr *MockIngestServerDaoMockRecorder) GetStreamSlot(ingestServerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIngestServerDaoMockRecorder) GetTranscodedStreamSlot(ingestServerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIngestServerDaoMockRecorder) RemoveStreamFromSlot(streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIngestServerDaoMockRecorder) SaveIngestServer(server any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIngestServerDaoMockRecorder) SaveSlot(slot any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
