...
//
//	mockgen -source=progress.go -destination ../mock_dao/progress.go
//
...
func (mr *MockProgressDaoMockRecorder) GetProgressesForUser(userID any) *gomock.Call {
...
func (mr *MockProgressDaoMockRecorder) LoadProgress(userID, streamIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProgressDaoMockRecorder) SaveProgresses(progresses any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProgressDaoMockRecorder) SaveWatchedState(progress any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
