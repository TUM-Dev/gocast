...
//
//	mockgen -source=courses.go -destination ../mock_dao/courses.go
//
...
func (mr *MockCoursesDaoMockRecorder) AddAdminToCourse(userID, courseID any) *gomock.Call {
...
func (mr *MockCoursesDaoMockRecorder) CreateCourse(ctx, course, keep any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) DeleteCourse(course any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) ExecAllCourses(f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetAdministeredCoursesByUserId(ctx, userid, teachingTerm, year any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetAllCoursesWithTUMIDFromSemester(ctx, year, term any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCoursesDao) GetAvailableSemesters(c context.Context, includeTestSemester bool) []model.Semester {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAvailableSemesters", c, includeTestSemester)
	ret0, _ := ret[0].([]model.Semester)
	return ret0
}

// GetAvailableSemesters indicates an expected call of GetAvailableSemesters.
func (mr *MockCoursesDaoMockRecorder) GetAvailableSemesters(c, includeTestSemester any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAvailableSemesters", reflect.TypeOf((*MockCoursesDao)(nil).GetAvailableSemesters), c, includeTestSemester)
}
...
func (mr *MockCoursesDaoMockRecorder) GetCourseAdmins(courseID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetCourseById(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetCourseByShortLink(link any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetCourseBySlugYearAndTerm(ctx, slug, term, year any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetCourseByToken(token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetCourseForLecturerIdByYearAndTerm(c, year, term, userId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetCurrentOrNextLectureForCourse(ctx, courseID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetInvitedUsersForCourse(course any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetPublicAndLoggedInCourses(year, term any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) GetPublicCourses(year, term any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) RemoveAdminFromCourse(userID, courseID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) UnDeleteCourse(ctx, course any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) UpdateCourseMetadata(ctx, course any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
