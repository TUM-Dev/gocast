...
func (mr *MockCoursesDaoMockRecorder) GetAvailableSemesters(c any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCoursesDaoMockRecorder) IsUserEnrolledInCourse(userID, courseID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
