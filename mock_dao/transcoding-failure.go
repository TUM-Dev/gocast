...
//
//	mockgen -source=transcoding-failure.go -destination ../mock_dao/transcoding-failure.go
//
...
func (mr *MockTranscodingFailureDaoMockRecorder) Delete(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTranscodingFailureDaoMockRecorder) New(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
