...
//
//	mockgen -source=streams.go -destination ../mock_dao/streams.go
//
...
func (mr *MockStreamsDaoMockRecorder) AddVodView(id any) *gomock.Call {
...
func (m *MockStreamsDao) ClearRunnerJobsForStream(streamID uint) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ClearRunnerJobsForStream", streamID)
	ret0, _ := ret[0].(error)
	return ret0
}

// ClearRunnerJobsForStream indicates an expected call of ClearRunnerJobsForStream.
func (mr *MockStreamsDaoMockRecorder) ClearRunnerJobsForStream(streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ClearRunnerJobsForStream", reflect.TypeOf((*MockStreamsDao)(nil).ClearRunnerJobsForStream), streamID)
}
...
func (mr *MockStreamsDaoMockRecorder) CreateOrGetTestCourse(user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) CreateStream(stream any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) DeleteLectureSeries(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) DeleteSilences(streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) DeleteStream(streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) DeleteStreamsWithTumID(ids any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) DeleteUnit(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) ExecAllStreamsWithCoursesAndSubtitlesBatched(f any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) GetCurrentLive(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) GetCurrentLiveNonHidden(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetDueStreamsForRunners mocks base method.
func (m *MockStreamsDao) GetDueStreamsForRunners() ([]model.Stream, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDueStreamsForRunners")
	ret0, _ := ret[0].([]model.Stream)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetDueStreamsForRunners indicates an expected call of GetDueStreamsForRunners.
func (mr *MockStreamsDaoMockRecorder) GetDueStreamsForRunners() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDueStreamsForRunners", reflect.TypeOf((*MockStreamsDao)(nil).GetDueStreamsForRunners))
}
...
func (mr *MockStreamsDaoMockRecorder) GetLiveStreamsInLectureHall(lectureHallId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetRunnerJobsForStream mocks base method.
func (m *MockStreamsDao) GetRunnerJobsForStream(streamID uint) ([]model.StreamRunnerJob, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRunnerJobsForStream", streamID)
	ret0, _ := ret[0].([]model.StreamRunnerJob)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetRunnerJobsForStream indicates an expected call of GetRunnerJobsForStream.
func (mr *MockStreamsDaoMockRecorder) GetRunnerJobsForStream(streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRunnerJobsForStream", reflect.TypeOf((*MockStreamsDao)(nil).GetRunnerJobsForStream), streamID)
}
...
func (mr *MockStreamsDaoMockRecorder) GetSoonStartingStreamInfo(user, slug, year, term any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) GetStreamByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) GetStreamByKey(ctx, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) GetStreamByTumOnlineID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) GetStreamsByIds(ids any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) GetStreamsWithWatchState(courseID, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) GetTranscodingProgressByVersion(streamVersion, streamId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) GetUnitByID(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) RemoveTranscodingProgress(streamVersion, streamId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) SaveCAMURL(stream, url any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) SaveCOMBURL(stream, url any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) SaveEndedState(streamID, hasEnded any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) SavePRESURL(stream, url any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SaveRunnerJobForStream mocks base method.
func (m *MockStreamsDao) SaveRunnerJobForStream(streamID uint, version model.StreamVersion, runnerHostname, jobID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveRunnerJobForStream", streamID, version, runnerHostname, jobID)
	ret0, _ := ret[0].(error)
	return ret0
}

// SaveRunnerJobForStream indicates an expected call of SaveRunnerJobForStream.
func (mr *MockStreamsDaoMockRecorder) SaveRunnerJobForStream(streamID, version, runnerHostname, jobID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveRunnerJobForStream", reflect.TypeOf((*MockStreamsDao)(nil).SaveRunnerJobForStream), streamID, version, runnerHostname, jobID)
}
...
func (mr *MockStreamsDaoMockRecorder) SaveStream(vod any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) SaveTranscodingProgress(progress any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) SaveWorkerForStream(stream, worker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) SetLectureHall(streamIDs, lectureHallID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) SetStreamLiveNowTimestampById(streamID, liveNowTimestamp any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) SetStreamNotLiveById(streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) ToggleVisibility(streamId, private any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) UpdateLectureSeries(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) UpdateSilences(silences, streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) UpdateStream(stream any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamsDaoMockRecorder) UpdateStreamFullAssoc(vod any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
