...
//
//	mockgen -source=chat.go -destination ../mock_dao/chat.go
//
...
func (mr *MockChatDaoMockRecorder) AddChatPoll(poll any) *gomock.Call {
...
func (mr *MockChatDaoMockRecorder) AddChatPollOptionVote(pollOptionId, userId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) AddMessage(chat any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) ApproveChat(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) CloseActivePoll(streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) DeleteChat(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) GetActivePoll(streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) GetAllChats(userID, streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) GetChat(id, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) GetChatUsers(streamid any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) GetChatsByUser(userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) GetPollOptionVoteCount(pollOptionId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) GetPollUserVote(pollId, userId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) GetPolls(streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockChatDao) GetReactions(chatID uint) ([]model.ChatReaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetReactions", chatID)
	ret0, _ := ret[0].([]model.ChatReaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetReactions indicates an expected call of GetReactions.
func (mr *MockChatDaoMockRecorder) GetReactions(chatID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetReactions", reflect.TypeOf((*MockChatDao)(nil).GetReactions), chatID)
}
...
func (mr *MockChatDaoMockRecorder) GetVisibleChats(userID, streamID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockChatDao) RemoveReactions(chatID uint) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RemoveReactions", chatID)
	ret0, _ := ret[0].(error)
	return ret0
}

// RemoveReactions indicates an expected call of RemoveReactions.
func (mr *MockChatDaoMockRecorder) RemoveReactions(chatID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemoveReactions", reflect.TypeOf((*MockChatDao)(nil).RemoveReactions), chatID)
}
...
func (mr *MockChatDaoMockRecorder) ResolveChat(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockChatDaoMockRecorder) RetractChat(id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockChatDao) ToggleReaction(userID, chatID uint, username, emoji string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ToggleReaction", userID, chatID, username, emoji)
	ret0, _ := ret[0].(error)
	return ret0
}

// ToggleReaction indicates an expected call of ToggleReaction.
func (mr *MockChatDaoMockRecorder) ToggleReaction(userID, chatID, username, emoji any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ToggleReaction", reflect.TypeOf((*MockChatDao)(nil).ToggleReaction), userID, chatID, username, emoji)
}
